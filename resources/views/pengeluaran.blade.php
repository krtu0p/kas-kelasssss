...
<head>
    ...
    <style>
        ...
        .card-total { background-color: #ff6666; color: white; padding: 15px; border-radius: 10px; }
...
<body class="bg-light">
    <div class="container py-5">
        ...
        <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card p-3 bg-dark text-white">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('pengeluaran.edit', $item->id) }}" class="btn btn-edit btn-sm me-2">✏️</a>
            ...
            @empty
                <div class="text-center">Tidak ada data pengeluaran untuk bulan ini.</div>
            @endforelse
        </div>

        <!-- Tambah Pengeluaran -->
        <div class="mt-4">
            <a href="{{ route('pengeluaran.create') }}" class="btn btn-tambah">Tambah</a>
        </div>
